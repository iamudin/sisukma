                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Total IKM</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e(round($data->ikm,2) ?? 0); ?></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><b><?php echo e($row->jumlah && $data->usia? round($row->jumlah / array_sum(array_column($data->usia,'jumlah')) * 100,2):0); ?>%</b></td>
                                    </tr>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <tbody>
                                    <?php $jlpendidikan = 0;?>
                                <?php $__currentLoopData = $data->pendidikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php $jlpendidikan +=$row;?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php $no=0; ?>
                                    <?php $__currentLoopData = $data->pendidikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><b><?php echo e($row && $jlpendidikan ? round($row/$jlpendidikan *100,2):0); ?>%</b></td>
                                    </tr>
                                    <?php $no++; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(Str::upper(Str::headline($k))); ?></td>
                                        <td><b><?php echo e($row); ?></b></td>
                                        <td><b><?php echo e($row && $jlpkerjaan ? round($row/$jlpkerjaan*100,2) : 0); ?>%</b></td>
                                    </tr>
                                    <?php $no++; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                        ...
                        <div class="col-xl-5 col-lg-5">
                            ...
                            <br>    
                            <a target="_blank" href="<?php echo e(url('survei/'.enc64(session('id_skpd')))); ?>"><img style="width:400px;height:400px" src="<?php echo e(toqr(url('survei/'.enc64(session('id_skpd'))))); ?>" height="100" ></a>
                        <br>
                        <br>
                        <a href="<?php echo e(url('printqr/'.session('id_skpd'))); ?>?print=true" class="btn btn-primary btn-md"> <i class="fa fa-download" aria-hidden="true"></i> Download QR</a>
                    </center>
                            <br>
                        </div>
                    </div>
...
<?php echo $__env->make('skpd.lihatsaran', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('periode', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sisukma\resources\views/skpd/dashboard.blade.php ENDPATH**/ ?>