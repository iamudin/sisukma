...
<body>
	<div class="container h-100">
		...
		<div class="d-flex justify-content-center h-100">
			...
			<center><img src="<?php echo e(url('logo.png')); ?>"  alt="Logo">
		<br>
		<br>
		...
		<small class="text-warning" style="font-weight:bold;text-shadow:0 1px 1px #000">Sistem Survei Kepuasan Masyarakat</small>
				...
				<div class="d-flex justify-content-center form_container" style="margin-top:30px">
					...
					<form method="POST" action="<?php echo e(URL::full()); ?>">
                        <?php echo csrf_field(); ?>
					...
					<br><a href="<?php echo e(url('/')); ?>" class="text-white">Kembali ke Halaman Utama</a></center>
				   </div>
					</form>
				</div>
...
<?php /**PATH C:\laragon\www\sisukma\resources\views/login.blade.php ENDPATH**/ ?>