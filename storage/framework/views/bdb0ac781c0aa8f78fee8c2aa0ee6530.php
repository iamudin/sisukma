...
<head>
  ...
  <!-- Vendor CSS Files -->
  <link href="<?php echo e(asset('back/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('back/vendor/bootstrap-icons/bootstrap-icons.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('back/vendor/aos/aos.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('back/vendor/glightbox/css/glightbox.min.css')); ?>" rel="stylesheet">
  <link href="<?php echo e(asset('back/vendor/swiper/swiper-bundle.min.css')); ?>" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="<?php echo e(asset('back/css/main.css')); ?>" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header d-flex align-items-center" style="background:rgb(13, 110, 253)">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="<?php echo e(url('/')); ?>"> <i class="fa fa-house"></i> &nbsp; Beranda</a></li>
          <li><a href="#services"> <i class="fa fa-chart-bar"></i> &nbsp; Statistik</a></li>
          <li><a href="<?php echo e(url('/gallery')); ?>"> <i class="fa fa-camera"></i> &nbsp;  Gallery</a></li>
  ...
  <section id="hero" class="hero" style="margin:0;padding:0">
   <img style="width:100%" src="<?php echo e(url('e-surve.webp')); ?>" alt="">
  </section>
...
<?php echo $__env->yieldContent('content'); ?>
  ...
  <script src="<?php echo e(asset('back/vendor/aos/aos.js')); ?>"></script>
  <script src="<?php echo e(asset('back/vendor/glightbox/js/glightbox.min.js')); ?>"></script>
  <script src="<?php echo e(asset('back/vendor/purecounter/purecounter_vanilla.js')); ?>"></script>
  <script src="<?php echo e(asset('back/vendor/swiper/swiper-bundle.min.js')); ?>"></script>
  <script src="<?php echo e(asset('back/vendor/isotope-layout/isotope.pkgd.min.js')); ?>"></script>
  <script src="<?php echo e(asset('back/vendor/php-email-form/validate.js')); ?>"></script>
...
<?php /**PATH C:\laragon\www\sisukma\resources\views/front/layoutfront.blade.php ENDPATH**/ ?>